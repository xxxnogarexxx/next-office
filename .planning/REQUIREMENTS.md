...
- [ ] **CAP-01**: Middleware generates a visitor_id (UUID) in an HTTP-only cookie on first visit and preserves it on return visits
- [ ] **CAP-02**: Middleware captures UTM parameters (source, medium, campaign, term, content) into HTTP-only cookies
