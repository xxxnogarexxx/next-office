            ...
            >
              <div className="flex items-center gap-4">
                ...
                <Button
                  size="sm"
                  variant="outline"
                  className="hidden shrink-0 border-border bg-transparent text-foreground hover:bg-surface sm:inline-flex"
              ...
              <Button
                size="sm"
                variant="outline"
                className="mt-3 border-border bg-transparent text-foreground hover:bg-surface sm:hidden"
                onClick={() => onSelectOffer(offer)}
              >
                Angebot erhalten
              </Button>
